...
const CTA = () => {
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <button className="bg-[#24272E] border text-white mt-4 px-6 py-2.5 rounded-lg font-light hover:bg-[#3a3c44] transition flex items-center justify-center gap-2 cursor-pointer mx-auto">
            Generate with AI
